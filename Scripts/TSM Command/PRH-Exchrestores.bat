...
cd\
cd\tsm\tdpexchange\
tdpexcc restorefiles "%UserInput3%" FULL /partial="%UserInput1%" /OBJECT=%UserInput2% /INTO=L:\Restores\vs01\%UserInput2%\ /fromexcserver=ukstrexvs01 /tsmoptfile=vs01_monthly.opt /tsmpassword=password
...
cd\
cd\tsm\tdpexchange\
tdpexcc restorefiles "%UserInput3%" FULL /partial="%UserInput1%" /OBJECT=%UserInput2% /INTO=L:\Restores\vs02\%UserInput2%\ /fromexcserver=ukstrexvs02 /tsmoptfile=vs02_monthly.opt /tsmpassword=wizard
